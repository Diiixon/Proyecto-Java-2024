 ...
 */
public class VerEspecialidades extends javax.swing.JFrame {

    /** Creates new form VerEspecialidades */
    public VerEspecialidades() {
        initComponents();
        setSize(900,600);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jtbl_especialidades = new javax.swing.JTable();
        jbtn_mostrar = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Mostrando Especialidades");
        ...
        jLabel1.setText("Ver Especialidades");
        ...
        jtbl_especialidades.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtbl_especialidades);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 100, 610, 310));
        ...
        jPanel2.add(jbtn_mostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 40, -1, -1));
    ...
    private void jbtn_mostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_mostrarActionPerformed
        ...
        DefaultTableModel modelo = (DefaultTableModel) this.jtbl_especialidades.getModel();
        
        modelo.setRowCount(0);
        
        ArrayList<Especialidad> lista = metodos.mostrarEspecialidad();
        for (Especialidad especialidad : lista) {
            id = especialidad.getIdEspecialidad();
            descripcion = especialidad.getDescEspecialidad();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerEspecialidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerEspecialidades().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jtbl_especialidades;
